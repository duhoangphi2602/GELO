...
import { SupportedDiseases } from "@/components/dashboard/SupportedDiseases";
      ...
      <div className="max-w-7xl mx-auto space-y-6 pb-12">
        ...
        <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-6 bg-white p-6 rounded-3xl border border-slate-100 shadow-sm">
          ...
          <div className="flex items-center gap-3">
            <div className="hidden sm:flex items-center gap-3 bg-slate-50 p-1.5 rounded-2xl border border-slate-100 pr-4">
              <div className="w-10 h-10 bg-white rounded-xl flex items-center justify-center shadow-sm text-[#2a64ad]">
                <ActivitySquare className="w-5 h-5" />
              </div>
              <div className="text-left">
                <span className="block text-[10px] font-black text-slate-400 uppercase tracking-wider">Health Score</span>
                <span className="text-sm font-black text-slate-800">94% Stability</span>
              </div>
            </div>
