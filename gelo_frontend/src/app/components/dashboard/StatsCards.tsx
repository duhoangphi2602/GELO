...
function StatCard({ title, value, icon: Icon, trend, color }: any) {
  ...
  return (
    <div className="cursor-pointer bg-white p-6 rounded-2xl shadow-sm border border-slate-200/60 flex flex-col relative overflow-hidden group hover:shadow-md transition-all hover:-translate-y-0.5 duration-300">
